        ...
        <div className="mt-12 border-t border-cream-100/15 pt-10">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <details
                key={v.code}
                className="group rounded-xl border border-cream-100/10 bg-white/5 transition-colors hover:border-gold-500/30"
              >
                <summary className="flex cursor-pointer items-center gap-3 px-4 py-3.5 [&::-webkit-details-marker]:hidden">
                  <span className="flex size-9 shrink-0 items-center justify-center rounded-lg bg-gold-500/15 text-lg">
                    {v.icon}
                  </span>
                  <span className="flex-1 text-sm font-semibold text-cream-100">
                    {v.name}{" "}
                    <span className="font-normal text-cream-200/60">{v.code}</span>
                  </span>
                  <span className="text-cream-200/50 transition-transform group-open:rotate-180">
                    ▾
                  </span>
                </summary>
